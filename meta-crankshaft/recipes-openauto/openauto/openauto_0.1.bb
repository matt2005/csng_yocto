...
SRCREV = "develop"
DEPENDS += " aasdk pulseaudio taglib librtaudio libqt5multimedia5 libqt5multimedia5-plugins libqt5multimediawidgets5 qtmultimedia5 libqt5bluetooth5 qtconnectivity5"
inherit cmake_qt5
